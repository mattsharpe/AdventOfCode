...
namespace Advent2015.Tests
{
    ...
    public class Day21Fixture
    {
        ...
        public void PlayerWins()
        {
            ...
            var player = new Player { HitPoints = 8, Damage = 5, Armour = 5 };
        ...
        public void FailingFirstPass()
        {
            ...
            var player = new Player { HitPoints = 100, Damage = 6, Armour = 3 };
        ...
        public void CorrectAnswer()
        {
            ...
            _day21.Boss = new Boss { HitPoints = 104, Damage = 8, Armour = 1 };
            var player = new Player { HitPoints = 100, Damage = 8, Armour = 1 };
