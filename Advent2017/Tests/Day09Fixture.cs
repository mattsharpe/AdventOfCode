...
namespace Advent2017.Tests
{
    ...
    public class Day09Fixture
    {
        ...
        public void Part1()
        {
            Assert.AreEqual(12505, _day9.GetTotalScore(FileReader.ReadFile("day09.txt")[0]));
        }
        ...
        public void Part2()
        {
            Assert.AreEqual(6671, _day9.SizeOfGarbage(FileReader.ReadFile("day09.txt")[0]));
        }
    }
}
